...
If res < 6 Then
    ...
    MiObj.Amount = RandomNumber(1, (UserList(UserIndex).Stats.UserSkills(Pesca) * 2))
...
If res < 6 Then
    ...
    Else
        MiObj.Amount = RandomNumber(1, (UserList(UserIndex).Stats.UserSkills(Talar)))
    End If
...
If res <= 5 Then
    ...
    Else
        MiObj.Amount = RandomNumber(1, (UserList(UserIndex).Stats.UserSkills(Mineria)))
    End If
