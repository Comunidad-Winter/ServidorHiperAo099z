...
Public Const NPCTYPE_GUARDIASKAOS = 7
...
Public Const FONTTYPE_WARNING = "~255~255~0~1~0"
...
Public Const FONTTYPE_FIGHT_MASCOTA = "~220~10~204-1-1"
Public Const FONTTYPE_SVIDA = "~0~128~255~1~0"

'Estadisticas
Public Const STAT_MAXELV = 115
Public Const STAT_MAXHP = 3000
Public Const STAT_MAXSTA = 10000
Public Const STAT_MAXMAN = 10000
Public Const STAT_MAXHIT = 300
Public Const STAT_MAXDEF = 1000
